...
static constexpr auto qt_meta_stringdata_ZN4infoE = QtMocHelpers::stringData(
    "info"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4infoE[] = {
...
Q_CONSTINIT const QMetaObject info::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4infoE.offsetsAndSizes,
    qt_meta_data_ZN4infoE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4infoE_t,
        // Q_OBJECT / Q_GADGET
...
void *info::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4infoE.stringdata0))
